...
describe('ValidateExercises', () => {
    ...
    test('renders the form correctly', () => {
        ...
        const blockButtons = screen.getAllByRole('button', { name: /Block Exercise/i });
        expect(blockButtons).toHaveLength(3);
        fireEvent.click(blockButtons[0]);
        expect(exerciseService.blockExercise).toHaveBeenCalledWith(1, expect.any(Function), expect.any(Function));

        expect(screen.getByText('Ejercicio bloqueado correctamente')).toBeInTheDocument();
    });
